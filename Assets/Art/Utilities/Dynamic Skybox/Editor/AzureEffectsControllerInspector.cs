...
namespace UnityEditor.AzureSky
{
    ...
    public class AzureEffectsControllerInspector : Editor
    {
        ...
        private SerializedProperty m_enableParticlesTriggerModule;
        private SerializedProperty m_enableParticlesSubEmittersModule;
        ...
        private SerializedProperty m_particlesTriggerCollider;
        ...
        private void OnEnable()
        {
            ...
            m_enableParticlesTriggerModule = serializedObject.FindProperty("m_enableParticlesTriggerModule");
            m_enableParticlesSubEmittersModule = serializedObject.FindProperty("m_enableParticlesSubEmittersModule");
            ...
            m_particlesTriggerCollider = serializedObject.FindProperty("m_particlesTriggerCollider");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_referencesHeaderGroup.isExpanded)
            {
                ...
                EditorGUILayout.PropertyField(m_particlesTriggerCollider);
                EditorGUI.indentLevel--;
            }
            ...
            if (m_settingsHeaderGroup.isExpanded)
            {
                ...
                EditorGUILayout.PropertyField(m_enableParticlesTriggerModule);
                EditorGUILayout.PropertyField(m_enableParticlesSubEmittersModule);
                EditorGUI.indentLevel--;
            }
            EditorGUILayout.EndFoldoutHeaderGroup();
            EditorGUILayout.Space(2);
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                m_target.SetParticlesTriggerModuleState(m_enableParticlesTriggerModule.boolValue);
                m_target.SetParticlesSubEmittersModuleState(m_enableParticlesSubEmittersModule.boolValue);
                m_target.SetParticlesTriggerCollider((Collider)m_particlesTriggerCollider.objectReferenceValue);
            }
        }
    }
}