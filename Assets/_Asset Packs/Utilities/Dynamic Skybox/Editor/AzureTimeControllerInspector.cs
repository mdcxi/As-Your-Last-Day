...
namespace UnityEditor.AzureSky
{
    ...
    public class AzureTimeControllerInspector : Editor
    {
            ...
            m_reorderableCeustomEventList = new ReorderableList(serializedObject, m_customEventList, true, true, true, true)
            {
                ...
                elementHeightCallback = (int index) =>
                {
                    if (m_customEventList.arraySize > 0)
                    {
                        ...
                        float expandedHeight = EditorGUI.GetPropertyHeight(element);
                        float closedHeight = EditorGUIUtility.standardVerticalSpacing + 5f;
                        if (element.isExpanded) return expandedHeight - 75f; else return expandedHeight + closedHeight;
                    }
                    else return 25f;
                },
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Label(" Version 7.0.8", EditorStyles.miniLabel);
